...
def fivethirtyeightPlot(group1, group2, group3 = None, lag = 0, save = None):
    ...
    print("MCS vs UWS")
    utils.to_find_statistical_differences(np.transpose(new), np.transpose(new2), threshold=0.01)

    print("HC vs MCS")
    utils.to_find_statistical_differences(np.transpose(new3), np.transpose(new), threshold=0.01)

    print("HC vs UWS")
    utils.to_find_statistical_differences(np.transpose(new3), np.transpose(new2), threshold=0.01)
